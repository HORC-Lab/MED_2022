...
z_dot_0 = 0;                                                    % (m/s) Initial vertical velocity of the point mass - System is always initiazed at MS
%------------------------------------------------------------------------------------------------%
...
[x2,x3,x4,x7,x8,x9] = xyz_to_ICs(x_0_star(1),x_0_star(2),x_0_star(3),x_0_star(4),x_0_star(5)+0.0,z_dot_0);
...
% x2 = r_A                                                      % Length of the foot for leg A
